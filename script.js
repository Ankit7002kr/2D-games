window.addEventListener("load", function () {
    ...
    constructor(game) {
      ...
      window.addEventListener("keydown", (e) => {
        if (
          ...
          this.game.debud = !this.game.debud;
        }
      });
    }
  }
  ...
  class Particle {
    ...
    update() {
      ...
      if (this.y > this.game.height + this.height || this.x < 0 - this.size)
        this.marked = true;
  ...
  class Player {
    ...
    shootBottom() {
      if (this.game.ammo > 0) {
        this.projectiles.push(new Projectile(game, this.x + 80, this.y + 175));
      }
    }
    ...
    enterPowerUp() {
      this.powerUpTimer = 0;
      this.powerUp = true;
      if (this.game.ammo < this.game.mxAmmo) this.game.ammo = this.game.mxAmmo;
    }
  }
  ...
  class Background {
    constructor(game) {
      ...
      this.layer3 = new Layer(this.game, this.image3, 4);
  ...
  class Explosion {
    ...
    update(deltaTime) {
      ...
      if (this.frameX > this.maxFrame) this.marked = true;
    }
    ...
    draw(context) {
      ...
      if (this.game.gameOver) {
        ...
        if (this.game.score > this.game.winningScore) {
          m1 = "Most Wondrous!";
          m2 = "Well Done Explorer!";
        } else {
          m1 = "Blazes!";
          m2 = "Get My Repair Kit & Try again!";
        }
